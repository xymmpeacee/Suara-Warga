...
<main class="max-w-lg mx-auto px-4 sm:px-6 py-16 sm:py-24 text-center">
    ...
    {{-- Spam Notice --}}
    <div class="inline-flex items-start gap-2.5 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 mb-8 text-left max-w-sm mx-auto">
        <svg class="w-4 h-4 text-amber-500 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z"/></svg>
        <p class="text-xs text-amber-700 leading-relaxed">
            Jika email tidak ditemukan di kotak masuk, silakan cek folder <strong>Spam/Junk</strong> dan tandai sebagai <strong>"Bukan Spam"</strong> agar notifikasi berikutnya masuk langsung ke inbox.
        </p>
    </div>
